...
import com.example.videplayer.UI_layer.Screen.Home_AfterPermission.LocalInterface
...
//              2. Background Color
 ...
 //              3. Top App Bar
            topBar = {
 //                  a- Define background color
                TopAppBar(
                    colors = TopAppBarDefaults.topAppBarColors(
                        containerColor = lightGray,
                        scrolledContainerColor = lightGray  // Prevent color change on scroll
...
//                  c- Scroll TopAppBar
                    ...
                    scrollBehavior = scrollHeading,

//                  d- TopAppBar Icons onclick
